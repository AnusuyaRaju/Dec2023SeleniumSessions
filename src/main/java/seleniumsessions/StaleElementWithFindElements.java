...
public class StaleElementWithFindElements {
	...
	public static void main(String[] args) {
		...
		//Can we get StaleElementReferenceException with multiple elements also...?
		...
		//Sometimes for each not working properly that's y go with For loop for index based looping it will be working fine
